...
*/
class AdminUpdateS3Content : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_ugc_EXPORT AdminUpdateS3Content() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_ugc_EXPORT virtual ~AdminUpdateS3Content() = default;
