...
class ListOutgoingFriendsResponse : public Response {
public:
    ACCELBYTE_LOBBY_API static const String& message_id();

    ACCELBYTE_LOBBY_API ListOutgoingFriendsResponse();
    ACCELBYTE_LOBBY_API virtual ~ListOutgoingFriendsResponse();
