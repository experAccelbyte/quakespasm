...
-	&lt;pre&gt;{ &#34;$data&#34;: &#34;value&#34; }&lt;/pre&gt;
*/
class AdminCreateUserPaymentOrder : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_platform_EXPORT AdminCreateUserPaymentOrder() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_platform_EXPORT virtual ~AdminCreateUserPaymentOrder() = default;
