...
#include "../responses/BlockUserResponse.h"
...
class BlockUser : public RequestWithResponse<responses::BlockUserResponse> {
public:
    ACCELBYTE_CHAT_API static const String& message_id();

    ACCELBYTE_CHAT_API BlockUser();
    ACCELBYTE_CHAT_API virtual ~BlockUser();
