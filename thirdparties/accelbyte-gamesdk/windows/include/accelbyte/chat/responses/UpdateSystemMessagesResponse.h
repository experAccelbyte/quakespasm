...
class UpdateSystemMessagesResponse : public Response {
public:
    ACCELBYTE_CHAT_API static const String& message_id();

    ACCELBYTE_CHAT_API UpdateSystemMessagesResponse();
    ACCELBYTE_CHAT_API virtual ~UpdateSystemMessagesResponse();
