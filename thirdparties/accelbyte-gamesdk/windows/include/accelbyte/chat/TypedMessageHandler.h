...
template <class L, class... R> class TypedMessageHandler;
...
public:
    ...
    TypedMessageHandler<TypedMessage>() {
      ...
      handle_message_func_[TypedMessage::message_id()] = 
          std::bind(&TypedMessageHandler<TypedMessage>::do_handle_message, this,
                std::placeholders::_1);
    }
...
class TypedMessageHandler : public TypedMessageHandler<TypedMessage>,
