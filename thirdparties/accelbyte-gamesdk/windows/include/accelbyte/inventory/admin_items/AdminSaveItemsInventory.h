...
*/
class AdminSaveItemsInventory : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_inventory_EXPORT AdminSaveItemsInventory() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_inventory_EXPORT virtual ~AdminSaveItemsInventory() = default;
    ...
    **/
     ...
     * @brief None
    **/
    accelbyte::Vector<model::SaveItemInventoryRequest> body{};
     /**
     * @brief inventoryID
    **/
