...
* @brief &lt;p&gt;&lt;b&gt;Fields :&lt;/b&gt;&lt;/p&gt;
	...
	&lt;/ul&gt;
*/
class AdminCreateLeaderboardConfigV3 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_leaderboard_EXPORT AdminCreateLeaderboardConfigV3() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_leaderboard_EXPORT virtual ~AdminCreateLeaderboardConfigV3() = default;
    ...
    **/
     ...
     * @brief None
    **/
    model::LeaderboardConfigRequestV3 body{};
     /**
