...
/**
* @brief Get game session detail by podname.
...
*/
class GetGameSessionByPodName : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_session_EXPORT GetGameSessionByPodName() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_session_EXPORT virtual ~GetGameSessionByPodName() = default;
