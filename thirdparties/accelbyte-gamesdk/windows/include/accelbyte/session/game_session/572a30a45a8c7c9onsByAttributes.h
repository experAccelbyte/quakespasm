...
*/
class AdminGetGameSessionsByAttributes : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_session_EXPORT AdminGetGameSessionsByAttributes() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_session_EXPORT virtual ~AdminGetGameSessionsByAttributes() = default;
    ...
    **/
    ...
    // usefull parameters    
     /**
     * @brief a list of attributes to filter from available sessions
    **/
