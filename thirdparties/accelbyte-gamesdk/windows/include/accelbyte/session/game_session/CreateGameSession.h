...
*/
class CreateGameSession : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_session_EXPORT CreateGameSession() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_session_EXPORT virtual ~CreateGameSession() = default;
    ...
    **/
    ...
    // usefull parameters    
     /**
     * @brief Create game session request
    **/
    model::CreateGameSessionRequest body{};
     /**
     * @brief Namespace
