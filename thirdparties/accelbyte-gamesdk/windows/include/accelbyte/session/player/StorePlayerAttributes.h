...
/**
* @brief This API behaves to upsert player&#39;s attributes.
...
*/
class StorePlayerAttributes : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_session_EXPORT StorePlayerAttributes() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_session_EXPORT virtual ~StorePlayerAttributes() = default;
    ...
    **/
    model::PlayerAttributesRequestBody body{};
     /**
     * @brief Namespace
