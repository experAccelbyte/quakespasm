...
/**
* @brief Modify template configuration
...
*/
class AdminUpdateConfigTemplateV1 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_session_EXPORT AdminUpdateConfigTemplateV1() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_session_EXPORT virtual ~AdminUpdateConfigTemplateV1() = default;
    ...
    **/
    ...
    // usefull parameters    
     /**
     * @brief Update configuration template request
    **/
    model::UpdateConfigTemplateRequest body{};
     /**
