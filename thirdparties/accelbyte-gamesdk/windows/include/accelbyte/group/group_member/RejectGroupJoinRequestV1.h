...
*/
class RejectGroupJoinRequestV1 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_group_EXPORT RejectGroupJoinRequestV1() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_group_EXPORT virtual ~RejectGroupJoinRequestV1() = default;
