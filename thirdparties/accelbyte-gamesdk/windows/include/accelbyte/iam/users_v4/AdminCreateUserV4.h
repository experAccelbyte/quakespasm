...
/**
* @brief Create a new user with unique email address and username.
**Required attributes:**
...
*/
class AdminCreateUserV4 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT AdminCreateUserV4() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~AdminCreateUserV4() = default;
