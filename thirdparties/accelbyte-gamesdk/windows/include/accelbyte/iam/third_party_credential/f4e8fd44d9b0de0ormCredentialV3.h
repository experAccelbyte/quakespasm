...
*/
class AdminUpdateThirdPartyLoginPlatformCredentialV3 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT AdminUpdateThirdPartyLoginPlatformCredentialV3() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~AdminUpdateThirdPartyLoginPlatformCredentialV3() = default;
