...
*/
class UnlinkAllPlatformV3 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT UnlinkAllPlatformV3() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~UnlinkAllPlatformV3() = default;
