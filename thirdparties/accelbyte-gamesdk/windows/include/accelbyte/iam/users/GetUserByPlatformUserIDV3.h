...
*/
class GetUserByPlatformUserIDV3 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT GetUserByPlatformUserIDV3() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~GetUserByPlatformUserIDV3() = default;
