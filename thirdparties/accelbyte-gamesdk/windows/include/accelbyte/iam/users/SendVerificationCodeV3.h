...
action code: 10116
*/
class SendVerificationCodeV3 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT SendVerificationCodeV3() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~SendVerificationCodeV3() = default;
