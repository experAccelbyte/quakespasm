...
*/
class SimultaneousLoginV4 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT SimultaneousLoginV4() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~SimultaneousLoginV4() = default;
