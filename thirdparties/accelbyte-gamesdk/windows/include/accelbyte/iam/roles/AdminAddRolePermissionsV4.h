...
*/
class AdminAddRolePermissionsV4 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT AdminAddRolePermissionsV4() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~AdminAddRolePermissionsV4() = default;
