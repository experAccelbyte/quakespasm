...
/**
* @brief Create role request body:
...
action code: 10401
*/
class AdminCreateRoleV3 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT AdminCreateRoleV3() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~AdminCreateRoleV3() = default;
    ...
    **/
     ...
     * @brief None
    **/
    model::RoleCreateV3Request body{};
};
