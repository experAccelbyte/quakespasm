...
/**
* @brief Updates multiple OAuth 2.0 clients.
...
*/
class AdminUpdateClientsV3 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT AdminUpdateClientsV3() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~AdminUpdateClientsV3() = default;
    ...
    **/
     ...
     * @brief None
    **/
    model::ClientsUpdateRequestV3 body{};
     /**
