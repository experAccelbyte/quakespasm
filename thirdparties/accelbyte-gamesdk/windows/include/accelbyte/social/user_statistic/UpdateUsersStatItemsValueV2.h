...
*/
class UpdateUsersStatItemsValueV2 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_social_EXPORT UpdateUsersStatItemsValueV2() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_social_EXPORT virtual ~UpdateUsersStatItemsValueV2() = default;
