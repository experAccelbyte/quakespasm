...
*/
class AdminUpdateUserStatItemValueV2 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_social_EXPORT AdminUpdateUserStatItemValueV2() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_social_EXPORT virtual ~AdminUpdateUserStatItemValueV2() = default;
