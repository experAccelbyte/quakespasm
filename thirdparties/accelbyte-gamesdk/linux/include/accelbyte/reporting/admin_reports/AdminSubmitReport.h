...
/**
* @brief Submit a report and will return ticket for reported object.
...
*/
class AdminSubmitReport : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_reporting_EXPORT AdminSubmitReport() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_reporting_EXPORT virtual ~AdminSubmitReport() = default;
