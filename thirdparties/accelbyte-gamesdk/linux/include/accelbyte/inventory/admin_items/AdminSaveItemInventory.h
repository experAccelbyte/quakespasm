...
*/
class AdminSaveItemInventory : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_inventory_EXPORT AdminSaveItemInventory() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_inventory_EXPORT virtual ~AdminSaveItemInventory() = default;
    ...
    **/
     ...
     * @brief None
    **/
    model::SaveItemInventoryRequest body{};
     /**
     * @brief inventoryID
    **/
