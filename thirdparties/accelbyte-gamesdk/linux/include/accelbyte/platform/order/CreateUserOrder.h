...
public:
    ...
    **/
	AB_platform_EXPORT CreateUserOrder() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_platform_EXPORT virtual ~CreateUserOrder() = default;
