...
*/
class AdminUpdatePaymentDomainWhitelistConfig : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_platform_EXPORT AdminUpdatePaymentDomainWhitelistConfig() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_platform_EXPORT virtual ~AdminUpdatePaymentDomainWhitelistConfig() = default;
