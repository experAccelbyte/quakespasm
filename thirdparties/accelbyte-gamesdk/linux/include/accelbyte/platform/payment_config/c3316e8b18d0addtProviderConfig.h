...
*/
class AdminUpdatePaymentProviderConfig : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_platform_EXPORT AdminUpdatePaymentProviderConfig() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_platform_EXPORT virtual ~AdminUpdatePaymentProviderConfig() = default;
