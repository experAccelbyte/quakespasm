...
*/
class AdminRefundDedicatedPaymentOrder : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_platform_EXPORT AdminRefundDedicatedPaymentOrder() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_platform_EXPORT virtual ~AdminRefundDedicatedPaymentOrder() = default;
