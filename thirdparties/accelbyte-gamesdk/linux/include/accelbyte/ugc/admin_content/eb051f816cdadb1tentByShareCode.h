...
*/
class AdminUpdateS3ContentByShareCode : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_ugc_EXPORT AdminUpdateS3ContentByShareCode() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_ugc_EXPORT virtual ~AdminUpdateS3ContentByShareCode() = default;
