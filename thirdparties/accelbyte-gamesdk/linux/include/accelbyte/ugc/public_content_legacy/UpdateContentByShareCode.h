...
*/
class UpdateContentByShareCode : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_ugc_EXPORT UpdateContentByShareCode() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_ugc_EXPORT virtual ~UpdateContentByShareCode() = default;
