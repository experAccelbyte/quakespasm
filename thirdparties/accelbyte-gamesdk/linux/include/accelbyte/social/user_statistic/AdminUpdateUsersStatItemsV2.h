...
*/
class AdminUpdateUsersStatItemsV2 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_social_EXPORT AdminUpdateUsersStatItemsV2() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_social_EXPORT virtual ~AdminUpdateUsersStatItemsV2() = default;
