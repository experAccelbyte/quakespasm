...
public:
    ...
    **/
	AB_challenge_EXPORT AdminCreateChallenge() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_challenge_EXPORT virtual ~AdminCreateChallenge() = default;
    ...
    **/
     ...
     * @brief None
    **/
    model::CreateChallengeRequest body{};
     /**
