...
*/
class AdminCreateGoal : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_challenge_EXPORT AdminCreateGoal() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_challenge_EXPORT virtual ~AdminCreateGoal() = default;
