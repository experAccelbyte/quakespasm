...
*/
class AdminCreateLeaderboardConfigV1 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_leaderboard_EXPORT AdminCreateLeaderboardConfigV1() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_leaderboard_EXPORT virtual ~AdminCreateLeaderboardConfigV1() = default;
