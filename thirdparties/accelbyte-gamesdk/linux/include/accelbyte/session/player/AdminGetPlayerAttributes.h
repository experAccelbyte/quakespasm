...
/**
* @brief Admin get attributes of a player.
...
*/
class AdminGetPlayerAttributes : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_session_EXPORT AdminGetPlayerAttributes() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_session_EXPORT virtual ~AdminGetPlayerAttributes() = default;
