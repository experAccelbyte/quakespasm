...
*/
class RejectGroupJoinRequestV2 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_group_EXPORT RejectGroupJoinRequestV2() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_group_EXPORT virtual ~RejectGroupJoinRequestV2() = default;
