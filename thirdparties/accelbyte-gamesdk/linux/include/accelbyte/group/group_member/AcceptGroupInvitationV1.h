...
*/
class AcceptGroupInvitationV1 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_group_EXPORT AcceptGroupInvitationV1() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_group_EXPORT virtual ~AcceptGroupInvitationV1() = default;
