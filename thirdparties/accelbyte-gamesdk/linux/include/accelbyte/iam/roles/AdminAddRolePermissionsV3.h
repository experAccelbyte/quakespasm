...
/**
* @brief This endpoint will ATTACH permission(s) into the role
action code: 10404
...
*/
class AdminAddRolePermissionsV3 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT AdminAddRolePermissionsV3() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~AdminAddRolePermissionsV3() = default;
