...
*/
class UpdateRolePermissions : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT UpdateRolePermissions() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~UpdateRolePermissions() = default;
