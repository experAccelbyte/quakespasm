...
action code : 10704
*/
class GrantPlatformTokenV4 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT GrantPlatformTokenV4() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~GrantPlatformTokenV4() = default;
