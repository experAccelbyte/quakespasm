...
*/
class AdminEnableMyAuthenticatorV4 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT AdminEnableMyAuthenticatorV4() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~AdminEnableMyAuthenticatorV4() = default;
