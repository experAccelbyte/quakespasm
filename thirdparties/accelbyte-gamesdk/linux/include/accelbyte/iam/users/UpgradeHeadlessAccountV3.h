...
/**
* @brief If validateOnly is set false, consume code and upgrade headless account and automatically verified the email address if it is succeeded
...
action code : 10124
*/
class UpgradeHeadlessAccountV3 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT UpgradeHeadlessAccountV3() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~UpgradeHeadlessAccountV3() = default;
