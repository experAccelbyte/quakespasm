...
/**
* @brief This endpoint will REPLACE user&#39;s permissions with the ones defined in body
...
*/
class AdminUpdateUserPermissionV3 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT AdminUpdateUserPermissionV3() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~AdminUpdateUserPermissionV3() = default;
