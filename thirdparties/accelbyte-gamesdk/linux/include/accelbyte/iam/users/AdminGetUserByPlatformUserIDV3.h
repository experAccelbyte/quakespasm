...
*/
class AdminGetUserByPlatformUserIDV3 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT AdminGetUserByPlatformUserIDV3() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~AdminGetUserByPlatformUserIDV3() = default;
