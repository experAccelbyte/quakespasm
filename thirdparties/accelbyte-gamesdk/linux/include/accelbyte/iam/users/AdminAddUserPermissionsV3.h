...
/**
* @brief This endpoint will APPEND user&#39;s permissions with the ones defined in body
...
*/
class AdminAddUserPermissionsV3 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT AdminAddUserPermissionsV3() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~AdminAddUserPermissionsV3() = default;
