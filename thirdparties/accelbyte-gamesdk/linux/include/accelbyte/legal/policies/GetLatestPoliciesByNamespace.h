...
public:
    ...
    **/
	AB_legal_EXPORT GetLatestPoliciesByNamespace() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_legal_EXPORT virtual ~GetLatestPoliciesByNamespace() = default;
