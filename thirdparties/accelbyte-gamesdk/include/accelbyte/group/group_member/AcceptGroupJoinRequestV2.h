...
*/
class AcceptGroupJoinRequestV2 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_group_EXPORT AcceptGroupJoinRequestV2() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_group_EXPORT virtual ~AcceptGroupJoinRequestV2() = default;
