...
/**
* @brief Create template configuration to be applied across party and session.
...
*/
class AdminCreateConfigTemplateV1 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_session_EXPORT AdminCreateConfigTemplateV1() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_session_EXPORT virtual ~AdminCreateConfigTemplateV1() = default;
    ...
    **/
    ...
    // usefull parameters    
     /**
     * @brief Create configuration template request
    **/
    model::CreateConfigTemplateRequest body{};
     /**
