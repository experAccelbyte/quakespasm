...
/**
* @brief Admin get attributes of players.
...
*/
class AdminGetPlayersAttributes : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_session_EXPORT AdminGetPlayersAttributes() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_session_EXPORT virtual ~AdminGetPlayersAttributes() = default;
...
if not set the user namespace will be used.
    **/
    accelbyte::Optional<accelbyte::String> ab_namespace{};
     /**
     * @brief comma-separated userIDs 
    **/
    accelbyte::Optional<accelbyte::String> users{};
};
