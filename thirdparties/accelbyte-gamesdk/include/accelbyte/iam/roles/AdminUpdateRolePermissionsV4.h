...
*/
class AdminUpdateRolePermissionsV4 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT AdminUpdateRolePermissionsV4() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~AdminUpdateRolePermissionsV4() = default;
