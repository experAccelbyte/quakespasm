...
*/
class DeletePlatformLinkV2 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT DeletePlatformLinkV2() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~DeletePlatformLinkV2() = default;
