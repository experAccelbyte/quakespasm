...
*/
class AddUserPermission : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_iam_EXPORT AddUserPermission() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_iam_EXPORT virtual ~AddUserPermission() = default;
    ...
    **/
     ...
     * @brief None
    **/
    model::UpdatePermissionScheduleRequest body{};
     /**
     * @brief Action (1..15)
    **/
    long action{0};
