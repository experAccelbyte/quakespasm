...
class ListIncomingFriendsResponse : public Response {
public:
    ACCELBYTE_LOBBY_API static const String& message_id();

    ACCELBYTE_LOBBY_API ListIncomingFriendsResponse();
    ACCELBYTE_LOBBY_API virtual ~ListIncomingFriendsResponse();
