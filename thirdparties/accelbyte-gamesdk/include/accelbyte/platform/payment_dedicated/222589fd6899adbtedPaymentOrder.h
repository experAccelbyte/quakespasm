...
*/
class AdminCreateDedicatedPaymentOrder : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_platform_EXPORT AdminCreateDedicatedPaymentOrder() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_platform_EXPORT virtual ~AdminCreateDedicatedPaymentOrder() = default;
    ...
    **/
     ...
     * @brief None
    **/
    model::CreateExternalPaymentOrder body{};
     /**
     * @brief None
