...
*/
class S2SSubmitUserDeletion : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_gdpr_EXPORT S2SSubmitUserDeletion() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_gdpr_EXPORT virtual ~S2SSubmitUserDeletion() = default;
