...
*/
class AdminUpdateUsersStatItemsValueV2 : public accelbyte::http::SendableObject
{
public:
    ...
    **/
	AB_social_EXPORT AdminUpdateUsersStatItemsValueV2() = default;
	
    /**
    * @brief destrutor.
    **/
    AB_social_EXPORT virtual ~AdminUpdateUsersStatItemsValueV2() = default;
    ...
    **/
     ...
     * @brief None
    **/
    accelbyte::Vector<model::StatItemUpdates> body{};
     /**
     * @brief namespace
